...
//
    ...
    public class RxTableViewDataSourceProxy
        ...
        private var _commitForRowAtSequenceSentMessage: CachedCommitForRowAt?
        private var _commitForRowAtSequenceMethodInvoked: CachedCommitForRowAt?
        ...
        open override func methodInvoked(_ selector: Selector) -> Observable<[Any]> {
        ...
        open override func sentMessage(_ selector: Selector) -> Observable<[Any]> {
            MainScheduler.ensureExecutingOnScheduler()
